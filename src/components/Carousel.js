		...
		<div>
			<div className="hidden lg:block w-full self-center lg:h-[80vh] ">
				<Carousel slideInterval={5000} className="relative">
					...
					<img src={Img2} className="w-auto  h-auto " alt="..." />
					<img src={Img4} className="w-auto  h-auto " alt="..." />
					<img src={Img5} className="w-auto  h-auto " alt="..." />
				</Carousel>
				<div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2">
					<h1 className="text-white font-mainFont font-[450] text-[2.9rem] text-center tracking-wide w-screen drop-shadow-2xl">
						Search Your One From Thousands of
					</h1>
					<h1 className="text-[#297fff] font-mainFont font-[450] text-[2.9rem] text-center mb-7 tracking-wide drop-shadow-2xl">
						Games
					</h1>
					...
					<h1 className="text-white text-[1.2rem] font-mainFont mt-3 font-light text-center tracking-wider drop-shadow-2xl ">
            ...
            <img src={MImg5} className='w-screen  h-screen ' alt="..." /> */}
				...
				<div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 ">
					<h1 className="text-white font-mainFont font-[450] text-[2rem] w-[90vw] text-center tracking-wide drop-shadow-2xl">
						Search Your One From Thousands of
					</h1>
